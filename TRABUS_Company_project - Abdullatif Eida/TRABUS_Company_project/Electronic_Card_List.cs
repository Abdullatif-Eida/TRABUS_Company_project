...
{
    public partial class Electronic_Card_List : Form
    {
        public Electronic_Card_List()
        {
            InitializeComponent();
        }
        ...
        private void Electronic_Card_List_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand command1 = new SqlCommand("Select * from ElectronicCard", connect);
                {
                    connect.Open();
                ...
                cardLists[0] = new ElectronicCard_List();
